...
public:
    ...
    void start() override
    {
        ...
        //!straight to arming and setting apogee timers, so if launch is detected and during testing the launchDetected EEPROM 
        //!value is not changed it could lead to an inadvertent triggering of the mechanism
